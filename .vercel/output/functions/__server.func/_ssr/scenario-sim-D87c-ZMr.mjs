...
import { $ as fmtNum, B as Button, S as runDemoScenarioSim, U as EdgeBuyButton, X as cn, b as formatScenarioError, et as fmtPct, q as Panel, v as SCENARIO_SIM_DEMO_LABEL, y as buildScenarioRequest } from "./router-C7mZt9b6.mjs";
import { r as DeskChip } from "./marks-cAu9_BI-.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/scenario-sim-D87c-ZMr.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: "Scenario Sim (preview)"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-3 text-sm leading-relaxed text-muted",
				children: "Coming online. CLI-backed 10k re-run for Edge Pack — not a site login, and not a guarantee. Buy the pack; checkout later returns an unlock URL, not an account. The public board still shows one Make 12 cell."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-5 grid gap-3 sm:grid-cols-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EdgeBuyButton, {
					kind: "week",
					label: "Buy · $9 Week sample"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeskChip, {
						tone: "warn",
						children: "Coming online"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeskChip, { children: "CLI-backed" })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "mt-3 font-display text-2xl tracking-wide",
					children: "Scenario Sim"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mt-2 text-sm leading-relaxed text-muted",
					children: [
						"Pin one to three overrides, then read baseline vs scenario vs Δ. This desk run is a ",
						SCENARIO_SIM_DEMO_LABEL,
						". It is not a lock, not a guarantee, and not ROI."
					]
				}),
...
function ForceWinnerEditor({ index, row, teams, onChange, onRemove }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "rounded-lg bg-raised/60 p-3 shadow-[var(--shadow-border)] sm:p-4",
...
function HxBumpEditor({ bump, teams, disabled, onChange }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mt-5 rounded-lg bg-raised/60 p-3 shadow-[var(--shadow-border)] sm:p-4",
...
function ScenarioSimResult({ response, nameBySlug }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-2 text-sm text-muted",
			children: response.confidence_note || "Monte Carlo ± noise on 10k draws; not a lock."
		}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			children: ["Make field is not win title. Numbers above are a desk fixture until the AMD CLI is wired. ", response.confidence_note]
		})
	] });
}
function ScenarioSimPreviewLink({ search }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex flex-wrap items-center gap-2",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeskChip, { children: "Coming online" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeskChip, { children: "CLI-backed" })]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
			className: "mt-3 font-display text-2xl tracking-wide",
			children: "Scenario Sim (preview)"
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-3 text-sm leading-relaxed text-muted",
			children: "A 10k re-run with pinned winners and an optional HX bump — Edge Pack depth, not a wired engine on this page. The free board still shows one Make 12 cell. Monte Carlo noise; not a lock."
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-4",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				...
				children: "Open Scenario Sim (preview)"
			})
		})
	] });
}
//#endregion
export { ScenarioSimPanel as n, ScenarioSimPreviewLink as r, ScenarioSimGate as t };
