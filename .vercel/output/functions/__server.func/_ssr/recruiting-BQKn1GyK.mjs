...
import { A as Panel, C as ConfPills, I as fmtNum, N as cn, d as YEARS, k as PageHead, u as Route$8, z as inConf } from "./router-DSAUlc3p.mjs";
import { a as RankMove, o as RankNum, s as RankSpark, u as TeamMark } from "./marks-Co2r8jCu.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/recruiting-BQKn1GyK.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function RecruitingPage() {
	const rows = Route$8.useLoaderData();
	const year = Route$8.useSearch().year ?? 2026;
	const board = Route$8.useSearch().board ?? "class";
	const conf = Route$8.useSearch().conf ?? "All";
