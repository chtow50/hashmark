import { t as MODEL } from "./chicago-BAye5qRT.mjs";
import { S as require_jsx_runtime, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { C as PageHead, w as Panel } from "./router-BESdhWwq.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/model-MAw7XB7W.js
...
spread  = 0.050835 × d
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "The board is the full 136-team FBS set from the HASHMARK database — recruiting, portal, returning production, SP+/Elo/SRS, and 2026 rosters. Two-deeps are the listed TWO·DEEP charts for 89 programs and a rating-sorted projection for the rest (CFBD publishes no depth chart). Projected two-deeps are labelled as estimates." }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Indiana is sixth on the preseason AP ballot after a national title. HX has the Hoosiers eleventh. Talent composite is league-average; the model withholds credit when the roster does not match the résumé." }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Georgia and Ohio State are 1–2 here. The AP has Ohio State first and Oregon second; HX flips Oregon and Georgia because Georgia’s talent z-score is the strongest in the pool. Texas Tech’s résumé (prior +1.99) outruns its talent (+0.66), so the Red Raiders sit eighth in HX — above their AP tie at 12th, short of a playoff lock on last year alone." }),
