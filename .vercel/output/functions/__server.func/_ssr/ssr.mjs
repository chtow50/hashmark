...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DTnMHHFC.mjs");
...
var manifest = {
	"212fff7d2072b94c01d35d756a6846efbcca652fa93e6206b5e625d8fd64ecc1": {
		...
		importer: () => import("./queries-D92_H9az.mjs")
	},
	...
	"4fe58dd28fd7340a345c36b313f0f7fe83bb1daaeec7d6b97ee43c0751bef21c": {
		...
		importer: () => import("./edge-unlock-fn-BeYxUQBb.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dr-Eieow.mjs").then((n) => n.t),
