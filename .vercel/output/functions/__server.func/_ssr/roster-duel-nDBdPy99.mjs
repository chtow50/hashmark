...
import { A as fmtNum, k as fmtHeight } from "./router-BESdhWwq.mjs";
import { u as TeamMark } from "./marks-ckZKOuCF.mjs";
import { a as POS_ORDER } from "./positions-C8RvhdNc.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/roster-duel-nDBdPy99.js
...
function RosterDuel({ home, away, homeName, awayName, homeSlug, awaySlug, homeColor, awayColor }) {
	const h = group(home);
	const a = group(away);
	const rows = [];
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
						...
						children: homeSlug && homeColor ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
						...
						children: awaySlug && awayColor ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "inline-flex items-center justify-end gap-2",
							children: [awayName, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TeamMark, {
								slug: awaySlug,
								color: awayColor,
								logoSize: 18
							})]
