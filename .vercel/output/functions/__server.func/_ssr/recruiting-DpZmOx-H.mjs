...
import { a as RankMove, o as RankNum, s as RankSpark, u as TeamMark } from "./marks-CFWwdyeU.mjs";
import { $ as PageHead, N as Route$10, P as YEARS, ct as inConf, et as Panel, ot as fmtNum, q as ConfPills, rt as cn } from "./router-BeWPwHfO.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/recruiting-DpZmOx-H.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function RecruitingPage() {
	const rows = Route$10.useLoaderData();
	const year = Route$10.useSearch().year ?? 2026;
	const board = Route$10.useSearch().board ?? "class";
	const conf = Route$10.useSearch().conf ?? "All";
	...
	const ofYear = (0, import_react.useMemo)(() => {
		...
		return rows.filter((r) => r.classYear === year).filter((r) => inConf(r.conference, conf)).map((r) => {
	...
	const featured = (0, import_react.useMemo)(() => featuredByComposite(ofYear), [ofYear]);
	const tableRows = (0, import_react.useMemo)(() => {
		if (sort === "avgRating") return [...ofYear].sort((a, b) => compareAvgSort(a, b, dir));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			className: "mb-5 font-mono text-[11px] uppercase tracking-[0.16em] text-faint",
			children: [COMPOSITE_SOURCE.board, " · rated commits only"]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mb-5",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConfPills, {
				value: conf,
				to: "/recruiting",
				searchFor: (c) => ({
					year,
		...
		board === "cycle" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CycleTable, { cycle }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: featured.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						...
						" commits ·",
						" ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClassAvg, {
							avg: t.avgRating,
							five: t.fiveStars,
							four: t.fourStars,
							three: t.threeStars,
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: tableRows.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "px-3 py-3",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClassAvg, {
									avg: t.avgRating,
									five: t.fiveStars,
									four: t.fourStars,
									three: t.threeStars
...
function ClassAvg({ avg, five, four, three, withLabel = false }) {
