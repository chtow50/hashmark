import { i as fcsStubsForTeam, r as fcsStubIsFinal } from "./fcs-stubs-ByETAt0t.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/season-sim-wcS1JGbE.js
...
var sim_10k_2026_default = {
	meta: {
		...
		"as_of": "2026-09-09",
		"as_of_tz": "America/Chicago",
		"hx_source": "/workspace/cfb/week1_od_hx_ship_2026.json",
		"hx_policy": "live HX 2026.3 from week1_od_hx_ship_2026.json hx_post (C20 + Week-1 ΔHX); matchup = board",
		...
		"runtime_sec": 5.03,
		"hx_stamp": "HX 2026.3",
		"note": "Re-sim on live HX 2026.3 after Chase dual Make-12 flag; replaces pre-Δ 2026-09-06 draws for Make-field / Win-title"
	},
	teams: [
		{
			"name": "Notre Dame",
...
var SIM_10K_NOTE = `HX 2026.3 · 10k draws · as_of ${sim10k.meta.as_of}`;
...
//#endregion
export { make12FromSim as a, odTermLabel as c, week2Tape as d, week2Top25Tape as f, make12FieldLabel as i, week2BoardFlags as l, buildRemainingSchedule as n, make12PanelLede as o, buildSeasonSchedule as r, make12TitleLabel as s, boardDisagreementRows as t, week2SeasonTape as u };
