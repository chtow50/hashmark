...
//#region node_modules/.nitro/vite/services/ssr/assets/edge-unlock-fn-DCU1My9u.js
...
var verifyEdgeUnlock = createServerFn({ method: "GET" }).validator(object({ sessionId: string().optional() })).handler(verifyEdgeUnlock_createServerFn_handler, async ({ data }) => {
	...
	const { currentPackManifest } = await import("./edge-pack-files.server-DD7Fdf3H.mjs");
