...
import { c as formatKickDayTitle, h as todayChicago, l as isVegasOnlyFcs, p as predictMatchup, s as formatKickCt } from "./fcs-stubs-BIYqld0L.mjs";
import { n as require_react } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
import { S as require_jsx_runtime, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { c as ChevronRight, l as ChevronLeft } from "../_libs/lucide-react.mjs";
import { r as DeskChip, u as TeamMark } from "./marks-CFWwdyeU.mjs";
import { $ as PageHead, B as favoriteLine, K as Button, M as defaultWeek, Q as EdgePackStrip, U as formatVegas, V as featuredBook, W as selectWeekScopedFeatured, et as Panel, j as Route$9, q as ConfPills, rt as cn, st as fmtPct } from "./router-BeWPwHfO.mjs";
import { n as matchupChips, t as isWinnerFlip } from "./schedule-flags-BhJfR453.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/schedule-B_axYzUJ.js
...
function SchedulePage() {
	const { week, games, filtered, view, conf } = Route$9.useLoaderData();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EdgePackStrip, { compact: true }),
		...
		featured ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WeekScopedFeatured, { game: featured }) : null,
...
function WeekScopedFeatured({ game: g }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "mt-1 font-display text-xl tabular leading-none",
					children: hxLine
					...
					className: "mt-1 font-display text-xl tabular leading-none",
					children: book && bookLine ? `${bookLine} · O/U ${book.total}` : "—"
				})] })]
			}),
