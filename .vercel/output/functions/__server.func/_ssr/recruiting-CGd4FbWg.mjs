...
import { A as fmtNum, C as PageHead, D as cn, M as inConf, S as ConfPills, l as Route$6, u as YEARS, w as Panel } from "./router-BESdhWwq.mjs";
import { a as RankMove, d as TeamSwatch, o as RankNum, s as RankSpark } from "./marks-ckZKOuCF.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/recruiting-CGd4FbWg.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function RecruitingPage() {
	const rows = Route$6.useLoaderData();
	const year = Route$6.useSearch().year ?? 2026;
	const board = Route$6.useSearch().board ?? "class";
	const conf = Route$6.useSearch().conf ?? "All";
