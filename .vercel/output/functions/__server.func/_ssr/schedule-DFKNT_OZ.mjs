...
import { B as Button, F as favoriteLine, G as EdgePackStrip, K as PageHead, R as formatVegas, V as ConfPills, X as cn, c as Route$6, et as fmtPct, l as defaultWeek, q as Panel } from "./router-C7mZt9b6.mjs";
import { r as DeskChip, u as TeamMark } from "./marks-cAu9_BI-.mjs";
import { n as matchupChips, t as isWinnerFlip } from "./schedule-flags-CTG8esl3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/schedule-DFKNT_OZ.js
...
function SchedulePage() {
	const { week, games, filtered, view, conf } = Route$6.useLoaderData();
