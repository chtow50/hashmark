...
import { $ as Panel, nt as cn, q as EDGE } from "./router-CGhQgp6F.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/edge-board-DGszNURU.js
...
var hx_edge_confidence_schema_2026_default = {
	...
	confidence_tier_rules: {
		"A": {
			...
			"lean_band": "strong",
			"rule": "Top 25 slice, calibration ok (closer ≥ 50%), large |HX−Vegas| (≥ 4 pts), strong lean (≥ 15pp from 50). Winner flips allowed. Can lead the pack. Never a lock."
		},
		"B": {
			"tier": "B",
			"lead": false,
			...
			"lean_band": "strong",
			"rule": "Top 25 slice, calibration ok, small |HX−Vegas| (< 4 pts), strong lean. Same favorite as the book. Do not lead."
		},
		"C": {
			"tier": "C",
			"lead": false,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Tiers A–D, calibration FLAGS, edge and lean bands. Free board is public schedule HX vs Vegas. Paid pack is ranked confidence cards. Schema demo — not the full paid pack."
			}),
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [schema.bands.edge_size.large.rule, " → large"] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [schema.bands.edge_size.small.rule, " → small"] }),
