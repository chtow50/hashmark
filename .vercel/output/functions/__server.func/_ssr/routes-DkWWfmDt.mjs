import { i as formatKickDayTitle, r as formatKickCt, s as predictMatchup, t as MODEL } from "./chicago-BYU7n4bi.mjs";
import { S as require_jsx_runtime, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { c as ArrowRight } from "../_libs/lucide-react.mjs";
import { A as PageHead, C as Button, L as fmtNum, N as apLabel, P as cn, R as fmtPct, S as spreadGap, _ as AP_STAMP, b as featuredSlateWeek, h as Route$15, j as Panel, k as EdgePackStrip, v as favoriteLine, y as featuredBook } from "./router-C92n1aE7.mjs";
import { c as Stat, f as WinBar, l as TeamLink, n as DeltaChip, o as RankNum, u as TeamMark } from "./marks-CQW2acg4.mjs";
import { n as formatSeasonRecord } from "./season-record-BNAp7shU.mjs";
import { a as make12FromSim, c as odTermLabel, d as week2Tape, f as week2Top25Tape, l as week2BoardFlags, t as boardDisagreementRows, u as week2SeasonTape } from "./season-sim-BfATRojz.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DkWWfmDt.js
...
function DisagreementCard({ rows }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: "Largest gaps versus last stamped AP (Week 1, Sept. 8) — HX is Week 3. Not the preseason ballot."
		}),
...
function AccountabilityCard({ tape, top25, season, flags, movers }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mb-4 flex flex-wrap items-baseline justify-between gap-2",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "font-display text-2xl tracking-wide",
				children: "Week 2 tape"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-sm text-muted",
				children: "Full slate closer is a FLAG. Top 25 closer is the scorecard beat. HX not retuned."
			})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				to: "/stories/$slug",
				params: { slug: "week-2-tape" },
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-md border border-up/40 bg-raised/40 px-4 py-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-[11px] uppercase tracking-[0.14em] text-up",
							children: "Closer · Top 25"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-1 font-display text-2xl tabular leading-none text-fg sm:text-3xl",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			children: [
				"Top 25 MAE HX ",
				fmtNum(top25.mae_hx, 2),
				" / Vegas ",
				fmtNum(top25.mae_vegas, 2),
				". Vegas closer",
				" ",
				top25.vegas_closer,
				"."
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: "Board flags · pre-Δ · HX 2026.3"
		}),
...
function Home() {
	const { teams, games, featured } = Route$15.useLoaderData();
