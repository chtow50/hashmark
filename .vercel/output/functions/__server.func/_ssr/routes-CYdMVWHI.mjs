import { c as formatKickDayTitle, n as MODEL, p as predictMatchup, s as formatKickCt } from "./fcs-stubs-BIYqld0L.mjs";
import { S as require_jsx_runtime, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { u as ArrowRight } from "../_libs/lucide-react.mjs";
import { c as Stat, f as WinBar, l as TeamLink, n as DeltaChip, o as RankNum, u as TeamMark } from "./marks-CFWwdyeU.mjs";
import { $ as PageHead, B as favoriteLine, C as week3BoardFlags, E as week3Top25Tape, G as spreadGap, H as featuredSlateWeek, K as Button, Q as EdgePackStrip, R as Route$17, S as odTermLabel, T as week3Tape, V as featuredBook, et as Panel, nt as apLabel, ot as fmtNum, rt as cn, st as fmtPct, v as make12FromSim, w as week3SeasonTape, x as boardDisagreementRows, z as AP_STAMP } from "./router-BeWPwHfO.mjs";
import { n as formatSeasonRecord } from "./season-record-DG1ReG_3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CYdMVWHI.js
...
function AccountabilityCard({ tape, top25, season, flags, movers, weekLabel = "Week 3 tape", storySlug = "week-3-tape", dek = "Full slate closer is a FLAG. Top 25 closer 5/21. HX not retuned.", flagsKicker = "Board flags · HX not retuned" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-md border border-warn/40 bg-raised/40 px-4 py-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-[11px] uppercase tracking-[0.14em] text-warn",
							children: "Closer · FLAG"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-1 font-display text-2xl tabular leading-none text-fg sm:text-3xl",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-1.5 text-xs tabular text-muted",
							children: [fmtNum(top25.su_pct, 1), "%"]
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: cn("rounded-md border bg-raised/40 px-4 py-3", top25CloserFlag ? "border-warn/40" : "border-up/40"),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: cn("text-[11px] uppercase tracking-[0.14em]", top25CloserFlag ? "text-warn" : "text-up"),
							children: top25CloserFlag ? "Closer · Top 25 · FLAG" : "Closer · Top 25"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-1 font-display text-2xl tabular leading-none text-fg sm:text-3xl",
							children: top25.hx_closer
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-1.5 text-xs tabular text-muted",
							children: [fmtNum(top25.hx_closer_pct, 1), "%"]
						})
					]
				})
			]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			children: [
				"Slate MAE HX ",
				fmtNum(tape.mae_hx, 2),
				" / Vegas ",
				fmtNum(tape.mae_vegas, 2),
				". ATS ",
				tape.hx_ats,
				". Vegas closer ",
				tape.vegas_closer,
				".",
				top25.mae_hx != null && top25.mae_vegas != null ? ` Top 25 MAE HX ${fmtNum(top25.mae_hx, 2)} / Vegas ${fmtNum(top25.mae_vegas, 2)}.` : ` Top 25 Vegas closer ${top25.vegas_closer}.`
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			children: [
				...
				season.label,
				": SU ",
				fmtNum(season.su_pct, 1),
				"% · closer ",
				fmtNum(season.hx_closer_pct, 1),
				"%"
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-5 font-mono text-[11px] uppercase tracking-[0.14em] text-faint",
			children: flagsKicker
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: "mt-2",
			children: flags.map((flag) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: cn("shrink-0 pt-0.5 text-[11px] uppercase tracking-[0.12em]", flag.result === "HIT" ? "text-up" : "text-down"),
					children: flag.result
				})]
			}, flag.id))
		}),
		movers && movers.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-5 font-mono text-[11px] uppercase tracking-[0.14em] text-faint",
			children: "Week 1 HX movers · term = O/D"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: "mt-2",
...
function Home() {
	const { teams, games, featured } = Route$17.useLoaderData();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHead, {
				kicker: `Week 4 · HX ${MODEL.version}`,
				title: `Week 4 board`,
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stat, {
								...
								hint: AP_STAMP.columnHint
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stat, {
								label: "Make 12",
								value: oneMake?.makeField != null ? fmtPct(oneMake.makeField, 1) : fmtPct(one.playoffOdds, 0),
								hint: oneMake?.makeFieldSource === "amd-draws" ? "make-field · HX 2026.4 10k" : void 0
							})
						]
					})]
				})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EdgePackStrip, {
				compact: true,
				paid: true
			}),
