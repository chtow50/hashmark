...
import { a as fcsStubsForTeam, i as fcsStubIsFinal, m as todayChicago, n as MODEL } from "./fcs-stubs-DntyZ00F.mjs";
...
import { l as ArrowRight, n as TriangleAlert, o as Menu, r as Search, t as X } from "../_libs/lucide-react.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shell-ri8sI6MR.js
...
function EdgePackStrip({ className, compact = false }) {
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/season-sim-D0w7Ca32.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/scenario-sim-CGNt6nWU.js
...
function buildScenarioRequest(input) {
	...
	return {
		...
		request: {
			...
			seed: input.seed === void 0 ? null : input.seed,
...
function runDemoScenarioSim(request) {
	...
	return {
		...
		confidence_note: fixture.confidence_note || "Monte Carlo ± noise on 10k draws; not a lock."
	};
}
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-C7mZt9b6.js
...
var styles_default = "/assets/styles-D7urEHlV.css";
...
var $$splitComponentImporter$14 = () => import("./routes-B67veR3K.mjs");
var Route$14 = createFileRoute("/")({
	loader: async () => {
		const [teams, games, slate] = await Promise.all([
			listTeams(),
			listGames(),
			listScheduleWeek({ data: { week: 3 } })
		]);
...
var $$splitComponentImporter$13 = () => import("./desk-0hi-FxGr.mjs");
...
var $$splitComponentImporter$12 = () => import("./edge-AUxiN0B2.mjs");
var Route$12 = createFileRoute("/edge")({
...
var $$splitComponentImporter$11 = () => import("./logos-Cu1qsg1q.mjs");
var Route$11 = createFileRoute("/logos")({
	loader: async () => listTeams(),
	component: lazyRouteComponent($$splitComponentImporter$11, "component"),
	head: () => ({ meta: [{ title: "Team logos · HASHMARK" }] })
});
var $$splitComponentImporter$10 = () => import("./matchup-DB9EECn2.mjs");
function parseNeutral(v) {
	if (v === true || v === "1" || v === "true") return true;
	if (v === false || v === "0" || v === "false") return false;
}
var Route$10 = createFileRoute("/matchup")({
	validateSearch: (s) => ({
...
var $$splitComponentImporter$9 = () => import("./model-DEoEgfA3.mjs");
var Route$9 = createFileRoute("/model")({
	component: lazyRouteComponent($$splitComponentImporter$9, "component"),
	head: () => ({ meta: [{ title: "The Model · HASHMARK" }] })
});
var $$splitComponentImporter$8 = () => import("./rankings-gD3c7gwq.mjs");
...
var $$splitComponentImporter$7 = () => import("./recruiting-CGKiRA3d.mjs");
...
var $$splitComponentImporter$6 = () => import("./schedule-DFKNT_OZ.mjs");
function parseWeek(v) {
	const n = typeof v === "number" ? v : typeof v === "string" ? Number(v) : NaN;
	if (!Number.isInteger(n) || n < 0 || n > 13) return void 0;
	return n;
}
var Route$6 = createFileRoute("/schedule")({
	validateSearch: (s) => {
...
var $$splitComponentImporter$5 = () => import("./states-BzX7GfNQ.mjs");
...
var $$splitComponentImporter$4 = () => import("./stories-BtCiHAd6.mjs");
var Route$4 = createFileRoute("/stories")({
	loader: () => listStories(),
	component: lazyRouteComponent($$splitComponentImporter$4, "component"),
	head: () => ({ meta: [{ title: "Stories · HASHMARK" }] })
});
var $$splitComponentImporter$3 = () => import("./talent-D3FxxT4v.mjs");
...
var $$splitComponentImporter$2 = () => import("./edge_.sim-KYTCzNoP.mjs");
var Route$2 = createFileRoute("/edge_/sim")({
	...
	head: () => ({ meta: [{ title: `Scenario Sim (preview) · ${EDGE.name}` }, {
		name: "description",
		content: "HX Edge Pack Scenario Sim preview. CLI-backed 10k re-run coming online. Desk fixture until the AMD engine is wired."
	}] })
});
var $$splitComponentImporter$1 = () => import("./stories._slug-CRjzRAZm.mjs");
...
var $$splitComponentImporter = () => import("./teams._slug-CX56Qlsj.mjs");
...
var EdgeRoute = Route$12.update({
	id: "/edge",
	path: "/edge",
	getParentRoute: () => Route$15
});
var LogosRoute = Route$11.update({
	id: "/logos",
	path: "/logos",
	getParentRoute: () => Route$15
});
var MatchupRoute = Route$10.update({
	id: "/matchup",
	path: "/matchup",
	getParentRoute: () => Route$15
});
var ModelRoute = Route$9.update({
	id: "/model",
	path: "/model",
	getParentRoute: () => Route$15
});
var RankingsRoute = Route$8.update({
	id: "/rankings",
	path: "/rankings",
	getParentRoute: () => Route$15
});
var RecruitingRoute = Route$7.update({
	id: "/recruiting",
	path: "/recruiting",
	getParentRoute: () => Route$15
});
var ScheduleRoute = Route$6.update({
	id: "/schedule",
	path: "/schedule",
	getParentRoute: () => Route$15
});
var StatesRoute = Route$5.update({
	id: "/states",
	path: "/states",
	getParentRoute: () => Route$15
});
...
var TalentRoute = Route$3.update({
	id: "/talent",
	path: "/talent",
	getParentRoute: () => Route$15
});
var EdgeSimRoute = Route$2.update({
	id: "/edge_/sim",
	path: "/edge/sim",
	getParentRoute: () => Route$15
});
...
//#endregion
export { fmtNum as $, odTermLabel as A, Button as B, boardDisagreementRows as C, make12FromSim as D, make12FieldLabel as E, favoriteLine as F, EdgePackStrip as G, EDGE as H, featuredBook as I, TeamSelect as J, PageHead as K, featuredSlateWeek as L, week2SeasonTape as M, week2Tape as N, make12PanelLede as O, week2Top25Tape as P, fmtHeight as Q, formatVegas as R, runDemoScenarioSim as S, buildSeasonSchedule as T, EdgeBuyButton as U, ConfPills as V, EdgeCheckoutNote as W, cn as X, apLabel as Y, deltaVsAp as Z, WEEK0_SLATE as _, Route$3 as a, formatScenarioError as b, Route$6 as c, YEARS as d, fmtPct as et, Route$8 as f, Route$14 as g, Route$12 as h, Route$2 as i, week2BoardFlags as j, make12TitleLabel as k, defaultWeek as l, Route$11 as m, Route as n, inConf as nt, Route$4 as o, Route$10 as p, Panel as q, Route$1 as r, Route$5 as s, router_exports as t, getStateDetail as tt, Route$7 as u, SCENARIO_SIM_DEMO_LABEL as v, buildRemainingSchedule as w, isScenarioSimUnlocked as x, buildScenarioRequest as y, spreadGap as z };
