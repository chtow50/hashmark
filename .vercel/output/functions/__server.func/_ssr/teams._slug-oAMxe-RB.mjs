import { f as modelShare, n as MODEL, p as predictMatchup, s as formatKickCt } from "./fcs-stubs-BIYqld0L.mjs";
import { S as require_jsx_runtime, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as RankMove, c as Stat, i as MixBar, n as DeltaChip, r as DeskChip, u as TeamMark } from "./marks-CFWwdyeU.mjs";
import { $ as PageHead, B as favoriteLine, U as formatVegas, _ as make12FieldLabel, at as fmtHeight, b as make12TitleLabel, et as Panel, g as buildSeasonSchedule, h as buildRemainingSchedule, n as Route$1, nt as apLabel, ot as fmtNum, rt as cn, st as fmtPct, v as make12FromSim, y as make12PanelLede } from "./router-BeWPwHfO.mjs";
import { c as TALENT_UNITS } from "./positions-C0zZnrTX.mjs";
import { n as RosterList } from "./roster-duel-Dq0PoPbW.mjs";
import { n as matchupChips, t as isWinnerFlip } from "./schedule-flags-BhJfR453.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/teams._slug-oAMxe-RB.js
...
function TeamHubScheduleRow({ row }) {
	...
	const pred = g && !vegasOnly ? predictMatchup({
		hxRating: g.homeHx,
	...
	const vegasLine = vegasSpread == null || vegasHomeShort == null || vegasAwayShort == null ? null : favoriteLine(vegasHomeShort, vegasAwayShort, vegasSpread);
	...
	const inner = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						row.isFcs ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: row.hxSpreadPolicy === "vegas_only_fcs_unrated" ? "Vegas-only" : "FCS stub"
						}) : null,
						row.live ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeskChip, {
							tone: "accent",
				...
				row.kickoffAt || row.tv ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
	...
	}) : vegasOnly ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatBlock, {
			...
			label: "Vegas",
			value: formatVegas(vegasLine, null)
		})]
	}) : null] });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				className: "mt-1 text-sm text-muted",
				children: "Unplayed FBS slate plus FCS stubs. HASHMARK spread and win% from HX; FCS is Vegas-only (no invented HASHMARK spread)."
...
function TeamPage() {
	const { team, players, games, classes } = Route$1.useLoaderData();
