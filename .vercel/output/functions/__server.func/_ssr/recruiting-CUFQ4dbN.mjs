...
import { B as ConfPills, G as PageHead, K as Panel, O as Route$7, Q as fmtNum, Y as cn, k as YEARS, tt as inConf } from "./router-Bx8kEb0W.mjs";
import { a as RankMove, o as RankNum, s as RankSpark, u as TeamMark } from "./marks-cAu9_BI-.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/recruiting-CUFQ4dbN.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function RecruitingPage() {
	const rows = Route$7.useLoaderData();
	const year = Route$7.useSearch().year ?? 2026;
	const board = Route$7.useSearch().board ?? "class";
