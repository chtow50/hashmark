...
import { C as PageHead, w as Panel } from "./router-D9ChcTpq.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/desk-BzFE4Ccf.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-sm leading-relaxed text-muted",
						children: "Week 2 held 37 of 47 straight-up. Closer 20/47 is a FLAG. Season W1–W2 is 81.1% SU, 44.4% closer. That split stays on the homepage because the model should be scored in public."
					}),
